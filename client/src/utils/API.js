...
// Get details of game
{
    ...
    "tba": true,
    "updated": "2023-08-25T17:46:17Z",
    "background_image": "https://api.rawg.io/api/games/{id}",
    "background_image_additional": "string",
    "website": "https://api.rawg.io/api/games/{id}",
    "rating": 0,
    "rating_top": 0,
    "ratings": {},
    "reactions": {},
    ...
    "reddit_logo": "https://api.rawg.io/api/games/{id}",
    "reddit_count": 0,
    "twitch_count": "string",
...
{
    "count": 0,
    "next": "https://api.rawg.io/api/games/{game_pk}/screenshots",
    "previous": "https://api.rawg.io/api/games/{game_pk}/screenshots",
    "results": [
      {
        "image": "@image.jpg",
        "hidden": false
...
{
    "count": 0,
    "next": "https://api.rawg.io/api/games/{game_pk}/stores",
    "previous": "https://api.rawg.io/api/games/{game_pk}/stores",
    "results": [
      {
        "id": 0,
        "game_id": "string",
        "store_id": "string",
        "url": "https://api.rawg.io/api/games/{game_pk}/stores"
      }
    ]
  }
...
// List of achievements/trophies
{
    ...
    "name": "string",
    "description": "string",
    "image": "https://api.rawg.io/api/games/{id}/achievements",
    "percent": "string"
  }
...
// List of game trailers
{
    "id": 0,
    "name": "string",
    "preview": "https://api.rawg.io/api/games/{id}/movies",
    "data": {}
  }
...
{
    "count": 0,
    "next": "https://api.rawg.io/api/genres",
    "previous": "https://api.rawg.io/api/genres",
    "results": [
      {
        "id": 0,
        "name": "string",
        "slug": "string",
        "games_count": 0,
        "image_background": "https://api.rawg.io/api/genres"
      }
    ]
  }
...
{
    "count": 0,
    "next": "https://api.rawg.io/api/platforms",
    "previous": "https://api.rawg.io/api/platforms",
    "results": [
      {
        "id": 0,
        "name": "string",
        "slug": "string",
        "games_count": 0,
        "image_background": "https://api.rawg.io/api/platforms",
        "image": "https://api.rawg.io/api/platforms",
        "year_start": 0,
        "year_end": 0
      }
    ]
